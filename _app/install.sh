...
## [id:curl]
## [prereqs:]
## Curl is a prerequisite of npm installation
...
## [id:npm]
## [prereqs:curl,nodejs]
#wget -O installnpm.sh http://npmjs.org/install.sh
#sudo sh ./installnpm.sh
#rm ./installnpm.sh
...
#wget -O coffeescript-$coffeescriptversion.tar.gz http://github.com/jashkenas/coffee-script/tarball/$coffeescriptversion 
#tar -xvzf coffeescript-$coffeescriptversion.tar.gz
#rm coffeescript-$coffeescriptversion.tar.gz
#cd jashkenas-coffee-script*
#rake
##cd ..
##rm -rf jashkenas-coffee-script*
